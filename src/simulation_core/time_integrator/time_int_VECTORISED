...
from src.simulation_core.potential_force.potentiel_force import build_potential_vector_force_torque_matrix
from src.simulation_core.potential_force.norms import build_inv_norm_matrix
# =============================================================================
# CONSTANTS
# =============================================================================
mmass = 18.015          # g/mol
